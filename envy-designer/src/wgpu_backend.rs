...
use crate::{
    DrawUniform, ViewUniform,
    tree::{PreparedGlyph, RenderBackend, TextLayoutArgs},
};
    ...
    pub fn new(
        ...
        let view_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            ...
            contents: bytemuck::bytes_of(&ViewUniform {
                ...
                proj_matrix: glam::Mat4::orthographic_rh(0.0, 1920.0, 1080.0, 0.0, 0.0, 1.0),
                padding: [0u8; 0x80],
            }),
...
impl RenderBackend for WgpuBackend {
    ...
    fn request_uniform(&mut self) -> Option<Self::UniformHandle> {
        ...
        self.uniforms.push(DrawUniform {
            model_matrix: glam::Mat4::IDENTITY,
            base_color: glam::Vec4::ONE,
            model_inverse_matrix: glam::Mat4::IDENTITY,
            padding: [0u8; 0x70],
        });
    ...
    fn layout_text(
        &mut self,
        args: crate::tree::TextLayoutArgs<'_, Self>,
    ) -> Vec<crate::tree::PreparedGlyph<Self>> {
